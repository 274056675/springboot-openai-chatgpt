...
import org.springblade.config.service.impl.MysqlTableHandle;
import org.springblade.config.service.impl.OracleTableHandle;
import org.springblade.config.service.impl.PgTableHandle;
import org.springblade.config.service.impl.SqlServerTableHandle;
...
public class TableUtil {
     ...
     * @return
     */
    public static Boolean tableNameIsuUable(String tableName){
        String excludeTableStr = MjjyConfig.getExcludeTable();
        if(Func.isEmpty(excludeTableStr)){
            return true;
        }
        String[] excludeTables = Func.toStrArray(excludeTableStr);

        if(Func.isEmpty(excludeTables)){
            return true;
        }
    ...
    public static Boolean isTableExist(String tableName) {
        ...
        try {
            ...
            rs = databaseMetaData.getTables(conn.getCatalog(), MjjyConfig.getDatabaseSchema(), dbTableName, tables);
            if (rs.next()) {
