...
public class BladexClient implements IMjkjBladexClient {
	...
	public R addQuestionNum(QuestionNumParam param){
		webService.addWxuserQuestionNum(param.getBladeUsrId(),param.getWxuserId(),param.getServiceType(),param.getNum(),null,null);
		return R.data("成功");
	}
	...
	public R subQuestionNum(QuestionNumParam param){
		webService.subWxuserQuestionNum(param.getBladeUsrId(),param.getWxuserId(),param.getServiceType(),param.getNum(),null,null);
		return R.data("成功");
	}
